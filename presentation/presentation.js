...
// and CommonJS for browser emulators (#13566)
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0__style_scss__ = __webpack_require__(2);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_0__style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__style_scss__);
        /* harmony import */
        ...
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js__ = __webpack_require__(3);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js__);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_3__node_modules_reveal_js_lib_js_head_min__ = __webpack_require__(4);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_3__node_modules_reveal_js_lib_js_head_min___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3__node_modules_reveal_js_lib_js_head_min__);
        /* harmony import */
        var __WEBPACK_IMPORTED_MODULE_4__js_addCustomPDFClass_js__ = __webpack_require__(5);


        window.Reveal = __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a;

        const isLocalHost = document.location.hostname === 'localhost' || document.location.protocol === 'file:';

// Full list of configuration options available at:
// https://github.com/hakimel/reveal.js#configuration
        __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.initialize({
            history: true,
            mouseWheel: isLocalHost,
            controls: isLocalHost,
            keyboard: isLocalHost,
            touch: isLocalHost,
            slideNumber: true,
            ...
            dependencies: [
                {
                    src: `./reveal-plugins/markdown/marked.js`, condition: function () {
                        return !!document.querySelector('[data-markdown]');
                    }
                },
                {
                    src: `./reveal-plugins/markdown/markdown.js`, condition: function () {
                        return !!document.querySelector('[data-markdown]');
                    }
                },
                {
                    src: `./reveal-plugins/highlight/highlight.js`, async: true, condition: function () {
                        return !!document.querySelector('pre code');
                    }, callback: function () {
                        hljs.initHighlightingOnLoad();
                    }
                },
                {src: `./reveal-plugins/zoom-js/zoom.js`, async: true},
...
// Callbacks
        __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.addEventListener('ready', function (event) {
// Adding PGS "squares" and counter
            __WEBPACK_IMPORTED_MODULE_1_jquery__(".slide-background").append('<div class="squares"><span>&nbsp;</span><span>&nbsp;</span><span>&nbsp;</span></div><div class="counter"><span class="c-h"></span>.<span class="c-v"></span></div>');

            // Counter inceremnts
            __WEBPACK_IMPORTED_MODULE_1_jquery__('.c-h').text(__WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.getIndices().h + 1);
            __WEBPACK_IMPORTED_MODULE_1_jquery__('.c-v').text(__WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.getIndices().v);
        });

        __WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.addEventListener('slidechanged', function (event) {
            // Counter inceremnts
            __WEBPACK_IMPORTED_MODULE_1_jquery__('.c-h').text(__WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.getIndices().h + 1);
            __WEBPACK_IMPORTED_MODULE_1_jquery__('.c-v').text(__WEBPACK_IMPORTED_MODULE_2__node_modules_reveal_js_js_reveal_js___default.a.getIndices().v);
        });
 ...
 */
    ...
    ﻿/*! head.core - v1.0.2 */
        ...
        (function (n, t) {
            ...
            var r = n.document, d = [], h = {}, c = {}, ut = "async" in r.createElement("script") || "MozAppearance" in r.documentElement.style || n.opera, o,
...
*/
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        (function () {
            ...
            link.rel = 'stylesheet';
            link.type = 'text/css';
            link.href = window.location.search.match(/print-pdf/gi) ? 'reveal-css/pdf.css' : 'reveal-css/paper.css';
            ...
            if (window.location.search.match(/print-pdf/gi)) {
                ...
                function addThemeClass() {
                    ...
                    sections.each(function (i, e) {
                        const parent = __WEBPACK_IMPORTED_MODULE_0_jquery__(e).parent();

                        if (parent.hasClass('pdf-page')) {
                            parent.addClass(__WEBPACK_IMPORTED_MODULE_0_jquery__(e).attr("data-state"));
                        }
                    });
                }
